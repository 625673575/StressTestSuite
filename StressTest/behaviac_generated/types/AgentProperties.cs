...
namespace behaviac
{
	...
	public class BehaviorLoaderImplement : BehaviorLoader
	{
		...
		{
			AgentMeta.TotalSignature = 96882801;
			...
			// RobotAgent
			meta = new AgentMeta(1368208911);
			AgentMeta._AgentMetas_[4246625381] = meta;
			meta.RegisterMemberProperty(2797727971, new CMemberProperty<int>("FrameCount", delegate(Agent self, int value) { ((RobotAgent)self).FrameCount = value; }, delegate(Agent self) { return ((RobotAgent)self).FrameCount; }));
			meta.RegisterMethod(209575916, new CAgentMethodVoid<bool>(delegate(Agent self, bool close) { }) /* Exit */);
			meta.RegisterMethod(4282902433, new CAgentMethodVoid<string>(delegate(Agent self, string message) { ((RobotAgent)self).Log(message); }));
			meta.RegisterMethod(1045109914, new CAgentStaticMethodVoid<string>(delegate(string param0) { RobotAgent.LogMessage(param0); }));
			meta.RegisterMethod(2521019022, new CMethod_behaviac_Agent_VectorAdd());
			meta.RegisterMethod(2306090221, new CMethod_behaviac_Agent_VectorClear());
			meta.RegisterMethod(3483755530, new CMethod_behaviac_Agent_VectorContains());
			meta.RegisterMethod(505785840, new CMethod_behaviac_Agent_VectorLength());
			...
			AgentMeta.Register<RobotAgent>("RobotAgent");
			return true;
		}
		...
		public override bool UnLoad()
		{
			...
			AgentMeta.UnRegister<RobotAgent>("RobotAgent");
			return true;
		}
	}
}
